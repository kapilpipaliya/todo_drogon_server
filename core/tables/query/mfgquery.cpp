...
void query_department_type(Table &t) {
...
void query_department(Table &t) {
  ...
  t.m_query.selectedColumns() = {
          ...
          sqlb::SelectedColumn({"Name", "name", "", "m", PG_TYPES::TEXT, true}),
          sqlb::SelectedColumn({"Department Type", "department_type_id", "", "m", PG_TYPES::INT8, true, 1, 1}),
          sqlb::SelectedColumn({"Name", "name", "", "dep_type", PG_TYPES::TEXT, false, 0, 0, false}),
          sqlb::SelectedColumn({"Parent", "parent_id", "", "m", PG_TYPES::INT8, true}),
...
void query_wax_setting(Table &t) {
...
void query_metal_issue(Table &t) {
