...
Json::Value save_address_type(const std::string &event1, const std::string &event2, const std::string &no, const WebSocketConnectionPtr &wsConnPtr, Json::Value in) {
  if (in["id"].asInt()) {
...
Json::Value save_contact_type(const std::string &event1, const std::string &event2, const std::string &no, const WebSocketConnectionPtr &wsConnPtr, Json::Value in) {
  if (in["id"].asInt()) {
...
Json::Value save_entity_type(const std::string &event1, const std::string &event2, const std::string &no, const WebSocketConnectionPtr &wsConnPtr, Json::Value in) {
  if (in["id"].asInt()) {
...
Json::Value save_entity(const std::string &event1, const std::string &event2, const std::string &no, const WebSocketConnectionPtr &wsConnPtr, Json::Value in) {
  if (in["id"].asInt()) {
...
Json::Value delete_entity(const std::string &event1, const std::string &event2, const std::string &no, const WebSocketConnectionPtr &wsConnPtr, Json::Value in) {
  pqxx::work txn{DD};
  try {
