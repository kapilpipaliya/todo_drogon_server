...
struct SelectedColumn {
    SelectedColumn(const std::string& original_column_, const std::string& selector_, const std::string& prefix, PG_TYPES column_type, bool isVisible, int offset=0, int tooltipOffset=0, bool isEditable=true)
        :
