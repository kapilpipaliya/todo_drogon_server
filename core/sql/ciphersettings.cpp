...
CipherSettings::CipherSettings()
    : keyFormat(Passphrase), pageSize(0), kdfIterations(0) {}
...
void CipherSettings::setPassword(const std::string &value) { password = value; }

int CipherSettings::getPageSize() const { return pageSize; }

void CipherSettings::setPageSize(int value) { pageSize = value; }
