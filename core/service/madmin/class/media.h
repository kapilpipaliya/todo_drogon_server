...
public:
     ...
     *
     */
    //virtual static function play_url($oid, $additional_params='', $player=null, $local=false) = 0;
    /**
     ...
     */
    //virtual void get_transcode_settings($target = null, $player = null, $options=array()) = 0;
    /**
     * get_stream_name
