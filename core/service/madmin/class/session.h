...
public:
    ...
    void setupTable() override;
         ...
         */
        //static void update_geolocation(std::string sid, std::string latitude, std::string longitude, std::string name);
        /**
         * get_geolocation
        ...
        //static void storeTokenForUser(std::string username, std::string token, std::string remember_length);
        //static void auth_remember();
        /**
         * ungimp_ie
         *
