...
//   void relation_column(type) {
//    if ( TYPES.key?(type) && TYPES[type][:reverse]) {
//      TYPES[type][:reverse]
//    } else if ( TYPES.key?(type) || type == TYPE_HIERARCHY) {
//      type
//    }
//  }
...
//   void from_work_package_or_ancestors(work_package) {
...
//   void from_parent_to_self_and_descendants(work_package) {
//    from_work_package_or_ancestors(work_package.parent)
//      .where(to_id: work_package.self_and_descendants.select(:id))
//  }

//   void from_self_and_descendants_to_ancestors(work_package) {
...
//   void canonical_type() {
//    this->class.canonical_type(relation_type)
//  }

//   void canonical_type(relation_type) {
...
//      was_column = this->class.relation_column(relation_type_was)
...
//      work_package_tmp = to
//      this->to = from
//      this->from = work_package_tmp
//      this->relation_type = TYPES[relation_type][:reverse]
//    }
//  }

//   void hierarchy_but_not_self(to:, from:) {
