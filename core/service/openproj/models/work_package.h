...
class WorkPackage : public openproj::models::ActiveRecord::Base,
 ...
 public:
  ...
  // include WorkPackageN::AskBeforeDestruction
  // include WorkPackageN::TimeEntries
  // include WorkPackageN::Ancestors
//  prepend WorkPackageN::Parent
//  // include WorkPackageN::TypedDagDefaults
//  // include WorkPackageN::CustomActions
...
//    WorkPackageN::AvailableCustomFields.for(project, type)
  }
