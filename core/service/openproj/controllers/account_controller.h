class AccountController : public ApplicationController {
  ...
  // User self-registration
   ...
   void allow_lost_password_recovery?() {
  ...
  // When making changes here, also check MyController.change_password
   void change_password() {
    ...
    change_password_flow(user: @user, params: params, show_user_name: true) {
  ...
  private
   ...
   void password_authentication(username, password) {
   ...
   void pending_omniauth_registration?() {
  ...
  // Log an attempt to log in to an account in "registered" state and show a flash message.
   void account_not_activated(flash_now: true) {
