...
public:
   virtual void seed() {
    if ( applicable()) {
      ...
      SPDLOG_TRACE("   *** #{not_applicable_message}");
    }
  }
   ...
   virtual void not_applicable_message() {
    SPDLOG_TRACE("Skipping #{this->class.name}");
  }
...
//    I18n.t(str, deep_interpolation: true, base_url: OpenProject::Configuration.rails_relative_url_root)
  }
