...
//        }
            ...
            drogon::orm::Mapper<drogon_model::openproject6::Types> mapper_type(clientPtr);
            auto type_task             = mapper_type.findBy(  Criteria(drogon_model::openproject6::Types::Cols::_name, CompareOperator::EQ, "Task"));
            auto type_milestone             = mapper_type.findBy(  Criteria(drogon_model::openproject6::Types::Cols::_name, CompareOperator::EQ, "Milestone"));
            auto type_phase             = mapper_type.findBy(  Criteria(drogon_model::openproject6::Types::Cols::_name, CompareOperator::EQ, "Phase"));
            auto type_feature             = mapper_type.findBy(  Criteria(drogon_model::openproject6::Types::Cols::_name, CompareOperator::EQ, "Feature"));
            auto type_epic             = mapper_type.findBy(  Criteria(drogon_model::openproject6::Types::Cols::_name, CompareOperator::EQ, "Epic"));
            auto type_user_story             = mapper_type.findBy(  Criteria(drogon_model::openproject6::Types::Cols::_name, CompareOperator::EQ, "User story"));
            auto type_bug             = mapper_type.findBy(  Criteria(drogon_model::openproject6::Types::Cols::_name, CompareOperator::EQ, "Bug"));

            drogon::orm::Mapper<drogon_model::openproject6::Statuses> mapper(clientPtr);
            auto new__             = mapper.findBy(  Criteria(drogon_model::openproject6::Statuses::Cols::_name, CompareOperator::EQ, "New"));
            auto in_specification_ = mapper.findBy(  Criteria(drogon_model::openproject6::Statuses::Cols::_name, CompareOperator::EQ, "In specification"));
            auto specified_        = mapper.findBy(  Criteria(drogon_model::openproject6::Statuses::Cols::_name, CompareOperator::EQ, "Specified"));
            auto confirmed_        = mapper.findBy(  Criteria(drogon_model::openproject6::Statuses::Cols::_name, CompareOperator::EQ, "Confirmed"));
            auto to_be_scheduled_  = mapper.findBy(  Criteria(drogon_model::openproject6::Statuses::Cols::_name, CompareOperator::EQ, "To be scheduled"));
            auto scheduled_        = mapper.findBy(  Criteria(drogon_model::openproject6::Statuses::Cols::_name, CompareOperator::EQ, "Scheduled"));
            auto in_progress_      = mapper.findBy(  Criteria(drogon_model::openproject6::Statuses::Cols::_name, CompareOperator::EQ, "In progress"));
            auto developed_        = mapper.findBy(  Criteria(drogon_model::openproject6::Statuses::Cols::_name, CompareOperator::EQ, "Developed"));
            auto in_testing_       = mapper.findBy(  Criteria(drogon_model::openproject6::Statuses::Cols::_name, CompareOperator::EQ, "In testing"));
            auto tested_           = mapper.findBy(  Criteria(drogon_model::openproject6::Statuses::Cols::_name, CompareOperator::EQ, "Tested"));
            auto test_failed_      = mapper.findBy(  Criteria(drogon_model::openproject6::Statuses::Cols::_name, CompareOperator::EQ, "Test failed"));
            auto closed_           = mapper.findBy(  Criteria(drogon_model::openproject6::Statuses::Cols::_name, CompareOperator::EQ, "Closed"));
            auto on_hold_          = mapper.findBy(  Criteria(drogon_model::openproject6::Statuses::Cols::_name, CompareOperator::EQ, "On hold"));
            auto rejected_         = mapper.findBy(  Criteria(drogon_model::openproject6::Statuses::Cols::_name, CompareOperator::EQ, "Rejected"));
