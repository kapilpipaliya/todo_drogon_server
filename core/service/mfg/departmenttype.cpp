...
DepartmentType::DepartmentType(const WebSocketConnectionPtr& wsConnPtr): wsConnPtr(wsConnPtr)
{
...
HANDLEEVENT(DepartmentType)

HEADERDATA(DepartmentType)
ALLDATA(DepartmentType)
delFn(DepartmentType)
