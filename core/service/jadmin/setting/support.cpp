...
namespace jewel {
namespace service {
Support::Support(std::shared_ptr<websocket::jewel::JAdminContext> context_)
...
void Support::setupTable() {
  ...
  query.setSelectedColumns({
      ...
      sql::SelectedColumn(
          {"Email", "email", "", "a", sql::PG_TYPES::TEXT, true}),
      sql::SelectedColumn(
          {"Phone", "phone", "", "a", sql::PG_TYPES::TEXT, true}),
      sql::SelectedColumn(
          {"Message", "message", "", "a", sql::PG_TYPES::TEXT, true}),
