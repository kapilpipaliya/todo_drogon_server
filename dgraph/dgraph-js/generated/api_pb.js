...
proto.api.Response.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    varsMap: (f = msg.getVarsMap()) ? f.toObject(includeInstance, proto.api.Uids.toObject) : [],
...
proto.api.Response.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      var value = msg.getVarsMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.api.Uids.deserializeBinaryFromReader, "");
         });
      break;
    case 12:
...
proto.api.Response.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getVarsMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(4, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.api.Uids.serializeBinaryToWriter);
  }
 ...
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.api.Uids>}
 */
proto.api.Response.prototype.getVarsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.api.Uids>} */ (
      jspb.Message.getMapField(this, 4, opt_noLazyCreate,
      proto.api.Uids));
};


proto.api.Response.prototype.clearVarsMap = function() {
  this.getVarsMap().clear();
};
