...
TEST_CASE("signup with a form.","[WSTest]") {
    SignUp w1; w1.setpath("/jadmin"); w1.init(); w1.run();
REQUIRE(w1.isTestSuccess() == true);
}
*/
#define GetTableD(s)                     \
...
TEST_CASE("check that all table data are correctly replied", "[WSTest]") {
  GetTableD("account_type")
      // GetTableD("account")
      GetTableD("account_heading") GetTableD("journal_type") GetTableD("txn")
          GetTableD("priority")
      ...
      GetTableD("metal") GetTableD("purity") GetTableD("tone")
          GetTableD("accessory")

              GetTableD("clarity") GetTableD("shape") GetTableD("d_color")
                  GetTableD("cs_color") GetTableD("cs_type") GetTableD("size")
                      GetTableD("d_size") GetTableD("cs_size")
      ...
      // GetTableD("option")
      GetTableD("product") GetTableD("post") GetTableD("category")
          GetTableD("tag") GetTableD("shipping_class") GetTableD("setting_type")
              GetTableD("certified_by") GetTableD("policy")
}
...
TEST_CASE("insert of ", "[WSTest]") {
  ...
  //        null, "=name1"]])"
  //        )
  SUD("account_heading", R"([{"name":"name", "accno": "12345"}])",
  ...
  //    SUD("txn",
  //        R"({"rank": 1234, "name":"name", "description": "Hi whats app"})",
  //        R"([      [null,null, "=name"]            ,{"rank": 12345,
  //        "name":"name1", "description": "Hi whats app1"}])", R"([[null, null,
  //        "=name1"]])"
  //        )
  SUD("priority", R"([{"rank": 1234, "slug": "slug", "name":"name"}])",
  ...
  //        "label":"label"
  //        }])",
  //        R"([              {"parent_id": 1,"rank": 1234, "slug": "slug1",
  //        "label":"label1"},  [null,null, null, "=slug"]   ])", R"([[null,
  //        null, null, "=slug1"]])"
  //        )
  //    SUD("wax_setting",
  //        R"({
  ...
  //        })",
  //        R"([      [null,null, "=name"]            ,{"name":"name1", "url":
  //        "12345688", "description": "Hi whats app1"}])", R"([[null, null,
  //        "=name1"]])"
  //        )
  //    SUD("metal",
  //        R"({"name":"name", "url": "123456", "description": "Hi whats
  ...
  //        null, "=name1"]])"
  //        )
  SUD("address_type", R"([{"name":"name"}])",
      R"([             {"name":"name1"},   [null,"=name"]   ])",
      R"([[null,"=name1"]])")
  SUD("contact_type", R"([{"name":"name"}])",
      R"([                 {"name":"name1"},   [null,"=name"]])",
      R"([[null,"=name1"]])")
  SUD("entity_type", R"([{"name":"name"}])",
      R"([               {"name":"name1"},  [null,"=name"]  ])",
      R"([[null,"=name1"]])")
  //    SUD("entity",
  //        R"({"name":"name", "url": "123456", "description": "Hi whats
...
//      R"([[null,  "=name1"]])")
  SUD("support",
      ...
      R"([[null, null, "=name1"]])")
  SUD("image_collection", R"([{"name":"name"}])",
      R"([            {"name":"name1"}  ,   [null,"=name"]  ])",
      R"([[null,"=name1"]])")
  //    SUD("image",
  //        R"({"name":"name", "url": "123456", "description": "Hi whats
  ...
  SUD("shipping_class",
      ...
      R"([[null, "=slug1"]])")
  SUD("setting_type", R"([{"name":"name", "description": "Hi whats app"}])",
