...
class CostObjectJournals
{
  public:
     ...
     */
    explicit CostObjectJournals(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit CostObjectJournals(const Json::Value &pJson) noexcept(false);
     ...
     */
    CostObjectJournals(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    CostObjectJournals() = default;
  ...
  private:
    friend Mapper<CostObjectJournals>;
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (journal_id,project_id,author_id,subject,description,fixed_date,created_on) values ($1,$2,$3,$4,$5,$6,$7) returning *";
        return sql;   
    }
};
} // namespace openproject6
