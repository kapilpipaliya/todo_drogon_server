...
class VersionSettings
{
  public:
     ...
     */
    explicit VersionSettings(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit VersionSettings(const Json::Value &pJson) noexcept(false);
     ...
     */
    VersionSettings(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (project_id,version_id,display,created_at,updated_at) values ($1,$2,$3,$4,$5) returning *";
        return sql;   
    }
};
} // namespace openproject6
