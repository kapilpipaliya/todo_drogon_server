...
bool CustomStyles::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("logo"))
    {
        if(!validJsonOfField(1, "logo", pJson["logo"], err, true))
            return false;
    }
    if(pJson.isMember("created_at"))
    {
    ...
    if(pJson.isMember("favicon"))
    {
        if(!validJsonOfField(4, "favicon", pJson["favicon"], err, true))
            return false;
    }
    if(pJson.isMember("touch_icon"))
    {
        if(!validJsonOfField(5, "touch_icon", pJson["touch_icon"], err, true))
            return false;
    }
    return true;
}
bool CustomStyles::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool CustomStyles::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("logo"))
    {
        if(!validJsonOfField(1, "logo", pJson["logo"], err, false))
            return false;
    }
    if(pJson.isMember("created_at"))
    {
    ...
    if(pJson.isMember("favicon"))
    {
        if(!validJsonOfField(4, "favicon", pJson["favicon"], err, false))
            return false;
    }
    if(pJson.isMember("touch_icon"))
    {
        if(!validJsonOfField(5, "touch_icon", pJson["touch_icon"], err, false))
            return false;
    }
    return true;
}
bool CustomStyles::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                    const std::vector<std::string> &pMasqueradingVector,
                                                    std::string &err)
{
    if(pMasqueradingVector.size() != 6)
...
bool CustomStyles::validJsonOfField(size_t index,
