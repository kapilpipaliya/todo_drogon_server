...
class RecaptchaEntries
{
  public:
     ...
     */
    explicit RecaptchaEntries(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit RecaptchaEntries(const Json::Value &pJson) noexcept(false);
     ...
     */
    RecaptchaEntries(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    RecaptchaEntries() = default;
  ...
  private:
    friend Mapper<RecaptchaEntries>;
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (user_id,created_at,updated_at,version) values ($1,$2,$3,$4) returning *";
        return sql;   
    }
};
} // namespace openproject6
