...
class WikiPages
{
  public:
     ...
     */
    explicit WikiPages(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit WikiPages(const Json::Value &pJson) noexcept(false);
     ...
     */
    WikiPages(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (wiki_id,title,created_on,protected,parent_id,slug,updated_at) values ($1,$2,$3,$4,$5,$6,$7) returning *";
        return sql;   
    }
};
} // namespace openproject6
