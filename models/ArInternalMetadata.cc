...
bool ArInternalMetadata::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("key"))
    {
    ...
    if(pJson.isMember("value"))
    {
        if(!validJsonOfField(1, "value", pJson["value"], err, true))
            return false;
    }
    if(pJson.isMember("created_at"))
    {
...
bool ArInternalMetadata::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool ArInternalMetadata::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("key"))
    {
    ...
    if(pJson.isMember("value"))
    {
        if(!validJsonOfField(1, "value", pJson["value"], err, false))
            return false;
    }
    if(pJson.isMember("created_at"))
    {
...
bool ArInternalMetadata::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                          const std::vector<std::string> &pMasqueradingVector,
                                                          std::string &err)
{
    if(pMasqueradingVector.size() != 4)
...
bool ArInternalMetadata::validJsonOfField(size_t index,
