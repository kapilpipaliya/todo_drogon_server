...
class WebhooksEvents
{
  public:
     ...
     */
    explicit WebhooksEvents(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit WebhooksEvents(const Json::Value &pJson) noexcept(false);
     ...
     */
    WebhooksEvents(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    WebhooksEvents() = default;
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (name,webhooks_webhook_id) values ($1,$2) returning *";
        return sql;   
    }
};
} // namespace openproject6
