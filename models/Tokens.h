...
class Tokens
{
  public:
     ...
     */
    explicit Tokens(const Row &r, const ssize_t indexOffset = 0) noexcept;
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (user_id,type,value,created_on,expires_on) values ($1,$2,$3,$4,$5) returning *";
        return sql;   
    }
};
} // namespace openproject6
