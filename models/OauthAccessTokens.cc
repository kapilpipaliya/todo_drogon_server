...
OauthAccessTokens::OauthAccessTokens(const Row &r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0)
    {
        if(!r["id"].isNull())
    ...
    else
    {
        ...
        if(!r[index].isNull())
        {
            _refreshToken=std::make_shared<std::string>(r[index].as<std::string>());
        }
        index = offset + 5;
        if(!r[index].isNull())
        {
        ...
        if(!r[index].isNull())
        {
            _previousRefreshToken=std::make_shared<std::string>(r[index].as<std::string>());
        }
    }

}

OauthAccessTokens::OauthAccessTokens(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[4].empty() && pJson.isMember(pMasqueradingVector[4]))
    {
        ...
        {
            _refreshToken=std::make_shared<std::string>(pJson[pMasqueradingVector[4]].asString());
        }
    }
    if(!pMasqueradingVector[5].empty() && pJson.isMember(pMasqueradingVector[5]))
    {
        ...
        {
            _expiresIn=std::make_shared<int32_t>((int32_t)pJson[pMasqueradingVector[5]].asInt64());
        }
    }
    ...
    if(!pMasqueradingVector[9].empty() && pJson.isMember(pMasqueradingVector[9]))
    {
        ...
        {
            _previousRefreshToken=std::make_shared<std::string>(pJson[pMasqueradingVector[9]].asString());
        }
    }
}

OauthAccessTokens::OauthAccessTokens(const Json::Value &pJson) noexcept(false)
{
    ...
    if(pJson.isMember("refresh_token"))
    {
        ...
        {
            _refreshToken=std::make_shared<std::string>(pJson["refresh_token"].asString());
        }
    }
    ...
    if(pJson.isMember("previous_refresh_token"))
    {
        _dirtyFlag[9]=true;
        if(!pJson["previous_refresh_token"].isNull())
        {
            _previousRefreshToken=std::make_shared<std::string>(pJson["previous_refresh_token"].asString());
        }
    }
}

void OauthAccessTokens::updateByMasqueradedJson(const Json::Value &pJson,
...
void OauthAccessTokens::updateByJson(const Json::Value &pJson) noexcept(false)
{
    if(pJson.isMember("id"))
    {
        if(!pJson["id"].isNull())
...
Json::Value OauthAccessTokens::toMasqueradedJson(
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 10)
    {
        ...
        if(!pMasqueradingVector[4].empty())
        {
            if(getRefreshToken())
            {
                ret[pMasqueradingVector[4]]=getValueOfRefreshToken();
            }
            else
            {
        ...
        if(!pMasqueradingVector[5].empty())
        {
            if(getExpiresIn())
            {
                ret[pMasqueradingVector[5]]=getValueOfExpiresIn();
            }
            else
            {
        ...
        if(!pMasqueradingVector[9].empty())
        {
            if(getPreviousRefreshToken())
            {
                ret[pMasqueradingVector[9]]=getValueOfPreviousRefreshToken();
            }
            else
            {
...
bool OauthAccessTokens::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("refresh_token"))
    {
        if(!validJsonOfField(4, "refresh_token", pJson["refresh_token"], err, true))
            return false;
    }
    if(pJson.isMember("expires_in"))
    {
        if(!validJsonOfField(5, "expires_in", pJson["expires_in"], err, true))
            return false;
    }
    if(pJson.isMember("revoked_at"))
    {
    ...
    if(pJson.isMember("previous_refresh_token"))
    {
        if(!validJsonOfField(9, "previous_refresh_token", pJson["previous_refresh_token"], err, true))
            return false;
    }
    return true;
}
bool OauthAccessTokens::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool OauthAccessTokens::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("refresh_token"))
    {
        if(!validJsonOfField(4, "refresh_token", pJson["refresh_token"], err, false))
            return false;
    }
    if(pJson.isMember("expires_in"))
    {
        if(!validJsonOfField(5, "expires_in", pJson["expires_in"], err, false))
            return false;
    }
    if(pJson.isMember("revoked_at"))
    {
    ...
    if(pJson.isMember("previous_refresh_token"))
    {
        if(!validJsonOfField(9, "previous_refresh_token", pJson["previous_refresh_token"], err, false))
            return false;
    }
    return true;
}
bool OauthAccessTokens::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                         const std::vector<std::string> &pMasqueradingVector,
                                                         std::string &err)
{
    if(pMasqueradingVector.size() != 10)
...
bool OauthAccessTokens::validJsonOfField(size_t index,
