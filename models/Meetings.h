...
class Meetings
{
  public:
     ...
     */
    explicit Meetings(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Meetings(const Json::Value &pJson) noexcept(false);
     ...
     */
    Meetings(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (title,author_id,project_id,location,start_time,duration,created_at,updated_at) values ($1,$2,$3,$4,$5,$6,$7,$8) returning *";
        return sql;   
    }
};
} // namespace openproject6
