...
class NewsJournals
{
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (journal_id,project_id,title,summary,description,author_id,comments_count) values ($1,$2,$3,$4,$5,$6,$7) returning *";
        return sql;   
    }
};
} // namespace openproject6
