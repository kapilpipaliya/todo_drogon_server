...
class ChangesetJournals
{
  public:
     ...
     */
    explicit ChangesetJournals(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ChangesetJournals(const Json::Value &pJson) noexcept(false);
     ...
     */
    ChangesetJournals(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (journal_id,repository_id,revision,committer,committed_on,comments,commit_date,scmid,user_id) values ($1,$2,$3,$4,$5,$6,$7,$8,$9) returning *";
        return sql;   
    }
};
} // namespace openproject6
