...
class Changes
{
  public:
     ...
     */
    explicit Changes(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Changes(const Json::Value &pJson) noexcept(false);
     ...
     */
    Changes(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (changeset_id,action,path,from_path,from_revision,revision,branch) values ($1,$2,$3,$4,$5,$6,$7) returning *";
        return sql;   
    }
};
} // namespace openproject6
