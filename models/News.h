...
class News
{
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (project_id,title,summary,description,author_id,created_on,comments_count) values ($1,$2,$3,$4,$5,$6,$7) returning *";
        return sql;   
    }
};
} // namespace openproject6
