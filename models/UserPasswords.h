...
class UserPasswords
{
  public:
     ...
     */
    explicit UserPasswords(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit UserPasswords(const Json::Value &pJson) noexcept(false);
     ...
     */
    UserPasswords(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    UserPasswords() = default;
  ...
  private:
    ...
    std::shared_ptr<std::string> _hashedPassword;
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (user_id,hashed_password,salt,created_at,updated_at,type) values ($1,$2,$3,$4,$5,$6) returning *";
        return sql;   
    }
};
} // namespace openproject6
