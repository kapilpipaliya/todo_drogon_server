...
class Wikis
{
  public:
    struct Cols
    {
        ...
        static const std::string _start_page;
     ...
     */
    explicit Wikis(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Wikis(const Json::Value &pJson) noexcept(false);
     ...
     */
    Wikis(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column start_page  */
    ///Get the value of the column start_page, returns the default value if the column is null
    const std::string &getValueOfStartPage() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getStartPage() const noexcept;
    ///Set the value of the column start_page
    void setStartPage(const std::string &pStartPage) noexcept;
    void setStartPage(std::string &&pStartPage) noexcept;
  ...
  private:
    ...
    std::shared_ptr<std::string> _startPage;
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (project_id,start_page,status,created_at,updated_at) values ($1,$2,$3,$4,$5) returning *";
        return sql;   
    }
};
} // namespace openproject6
