...
Rates::Rates(const Row &r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0)
    {
        if(!r["id"].isNull())
    ...
    else
    {
        ...
        if(!r[index].isNull())
        {
            _rate=std::make_shared<int64_t>(r[index].as<int64_t>());
        }
        index = offset + 3;
        if(!r[index].isNull())
        {
...
Rates::Rates(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[2].empty() && pJson.isMember(pMasqueradingVector[2]))
    {
        ...
        {
            _rate=std::make_shared<int64_t>((int64_t)pJson[pMasqueradingVector[2]].asInt64());
        }
    }
    ...
    if(!pMasqueradingVector[6].empty() && pJson.isMember(pMasqueradingVector[6]))
    {
        ...
        {
            _costTypeId=std::make_shared<int32_t>((int32_t)pJson[pMasqueradingVector[6]].asInt64());
        }
    }
}

Rates::Rates(const Json::Value &pJson) noexcept(false)
{
    ...
    if(pJson.isMember("valid_from"))
    {
        _dirtyFlag[1]=true;
        if(!pJson["valid_from"].isNull())
        {
            auto daysStr = pJson["valid_from"].asString();
            struct tm stm;
            memset(&stm,0,sizeof(stm));
            strptime(daysStr.c_str(),"%Y-%m-%d",&stm);
            long t = timelocal(&stm);
    ...
    if(pJson.isMember("rate"))
    {
        ...
        {
            _rate=std::make_shared<int64_t>((int64_t)pJson["rate"].asInt64());
        }
    }
...
void Rates::updateByMasqueradedJson(const Json::Value &pJson,
...
void Rates::updateByJson(const Json::Value &pJson) noexcept(false)
{
    if(pJson.isMember("id"))
    {
        if(!pJson["id"].isNull())
...
Json::Value Rates::toMasqueradedJson(
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 7)
    {
        ...
        if(!pMasqueradingVector[1].empty())
        {
            if(getValidFrom())
            {
                ret[pMasqueradingVector[1]]=getValidFrom()->toDbStringLocal();
            }
            else
            {
        ...
        if(!pMasqueradingVector[2].empty())
        {
            if(getRate())
            {
                ret[pMasqueradingVector[2]]=(Json::Int64)getValueOfRate();
            }
            else
            {
        ...
        if(!pMasqueradingVector[6].empty())
        {
            if(getCostTypeId())
            {
                ret[pMasqueradingVector[6]]=getValueOfCostTypeId();
            }
            else
            {
...
bool Rates::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("valid_from"))
    {
        if(!validJsonOfField(1, "valid_from", pJson["valid_from"], err, true))
            return false;
    }
    else
    {
        err="The valid_from column cannot be null";
        return false;
    }
    if(pJson.isMember("rate"))
    {
        if(!validJsonOfField(2, "rate", pJson["rate"], err, true))
            return false;
    }
    else
    {
        err="The rate column cannot be null";
        return false;
    }
    if(pJson.isMember("type"))
    {
    ...
    if(pJson.isMember("cost_type_id"))
    {
        if(!validJsonOfField(6, "cost_type_id", pJson["cost_type_id"], err, true))
            return false;
    }
    return true;
}
bool Rates::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool Rates::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("valid_from"))
    {
        if(!validJsonOfField(1, "valid_from", pJson["valid_from"], err, false))
            return false;
    }
    if(pJson.isMember("rate"))
    {
        if(!validJsonOfField(2, "rate", pJson["rate"], err, false))
            return false;
    }
    if(pJson.isMember("type"))
    {
    ...
    if(pJson.isMember("cost_type_id"))
    {
        if(!validJsonOfField(6, "cost_type_id", pJson["cost_type_id"], err, false))
            return false;
    }
    return true;
}
bool Rates::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                             const std::vector<std::string> &pMasqueradingVector,
                                             std::string &err)
{
    if(pMasqueradingVector.size() != 7)
...
bool Rates::validJsonOfField(size_t index,
