...
class MeetingContents
{
  public:
     ...
     */
    explicit MeetingContents(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit MeetingContents(const Json::Value &pJson) noexcept(false);
     ...
     */
    MeetingContents(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (type,meeting_id,author_id,text,lock_version,created_at,updated_at,locked) values ($1,$2,$3,$4,$5,$6,$7,$8) returning *";
        return sql;   
    }
};
} // namespace openproject6
