...
bool CostObjects::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
...
bool CostObjects::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool CostObjects::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
...
bool CostObjects::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                   const std::vector<std::string> &pMasqueradingVector,
                                                   std::string &err)
{
    if(pMasqueradingVector.size() != 9)
...
bool CostObjects::validJsonOfField(size_t index,
