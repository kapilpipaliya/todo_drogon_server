...
class CustomActionsProjects
{
  public:
     ...
     */
    explicit CustomActionsProjects(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit CustomActionsProjects(const Json::Value &pJson) noexcept(false);
     ...
     */
    CustomActionsProjects(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (project_id,custom_action_id) values ($1,$2) returning *";
        return sql;   
    }
};
} // namespace openproject6
