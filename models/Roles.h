...
class Roles
{
  public:
     ...
     */
    explicit Roles(const Row &r, const ssize_t indexOffset = 0) noexcept;
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (name,position,assignable,builtin,type) values ($1,$2,$3,$4,$5) returning *";
        return sql;   
    }
};
} // namespace openproject6
