...
bool PlaintextTokens::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
...
bool PlaintextTokens::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool PlaintextTokens::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
...
bool PlaintextTokens::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                       const std::vector<std::string> &pMasqueradingVector,
                                                       std::string &err)
{
    if(pMasqueradingVector.size() != 5)
...
bool PlaintextTokens::validJsonOfField(size_t index,
