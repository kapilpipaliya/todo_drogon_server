...
bool TimeEntries::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("hours"))
    {
        if(!validJsonOfField(4, "hours", pJson["hours"], err, true))
            return false;
    }
    else
    {
    ...
    if(pJson.isMember("activity_id"))
    {
        if(!validJsonOfField(6, "activity_id", pJson["activity_id"], err, true))
            return false;
    }
    else
    {
    ...
    if(pJson.isMember("spent_on"))
    {
        if(!validJsonOfField(7, "spent_on", pJson["spent_on"], err, true))
            return false;
    }
    else
    {
    ...
    if(pJson.isMember("tyear"))
    {
        if(!validJsonOfField(8, "tyear", pJson["tyear"], err, true))
            return false;
    }
    else
    {
    ...
    if(pJson.isMember("tmonth"))
    {
        if(!validJsonOfField(9, "tmonth", pJson["tmonth"], err, true))
            return false;
    }
    else
    {
    ...
    if(pJson.isMember("tweek"))
    {
        if(!validJsonOfField(10, "tweek", pJson["tweek"], err, true))
            return false;
    }
    else
    {
    ...
    if(pJson.isMember("created_on"))
    {
        if(!validJsonOfField(11, "created_on", pJson["created_on"], err, true))
            return false;
    }
    else
    {
    ...
    if(pJson.isMember("updated_on"))
    {
        if(!validJsonOfField(12, "updated_on", pJson["updated_on"], err, true))
            return false;
    }
    else
    {
    ...
    if(pJson.isMember("overridden_costs"))
    {
        if(!validJsonOfField(13, "overridden_costs", pJson["overridden_costs"], err, true))
            return false;
    }
    if(pJson.isMember("costs"))
    {
        if(!validJsonOfField(14, "costs", pJson["costs"], err, true))
            return false;
    }
    if(pJson.isMember("rate_id"))
    {
        if(!validJsonOfField(15, "rate_id", pJson["rate_id"], err, true))
            return false;
    }
    return true;
}
bool TimeEntries::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool TimeEntries::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("hours"))
    {
        if(!validJsonOfField(4, "hours", pJson["hours"], err, false))
            return false;
    }
    if(pJson.isMember("comments"))
    {
    ...
    if(pJson.isMember("activity_id"))
    {
        if(!validJsonOfField(6, "activity_id", pJson["activity_id"], err, false))
            return false;
    }
    if(pJson.isMember("spent_on"))
    {
        if(!validJsonOfField(7, "spent_on", pJson["spent_on"], err, false))
            return false;
    }
    if(pJson.isMember("tyear"))
    {
        if(!validJsonOfField(8, "tyear", pJson["tyear"], err, false))
            return false;
    }
    if(pJson.isMember("tmonth"))
    {
        if(!validJsonOfField(9, "tmonth", pJson["tmonth"], err, false))
            return false;
    }
    if(pJson.isMember("tweek"))
    {
        if(!validJsonOfField(10, "tweek", pJson["tweek"], err, false))
            return false;
    }
    if(pJson.isMember("created_on"))
    {
        if(!validJsonOfField(11, "created_on", pJson["created_on"], err, false))
            return false;
    }
    if(pJson.isMember("updated_on"))
    {
        if(!validJsonOfField(12, "updated_on", pJson["updated_on"], err, false))
            return false;
    }
    if(pJson.isMember("overridden_costs"))
    {
        if(!validJsonOfField(13, "overridden_costs", pJson["overridden_costs"], err, false))
            return false;
    }
    if(pJson.isMember("costs"))
    {
        if(!validJsonOfField(14, "costs", pJson["costs"], err, false))
            return false;
    }
    if(pJson.isMember("rate_id"))
    {
        if(!validJsonOfField(15, "rate_id", pJson["rate_id"], err, false))
            return false;
    }
    return true;
}
bool TimeEntries::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                   const std::vector<std::string> &pMasqueradingVector,
                                                   std::string &err)
{
    if(pMasqueradingVector.size() != 16)
...
bool TimeEntries::validJsonOfField(size_t index,
