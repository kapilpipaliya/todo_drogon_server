...
AttributeHelpTexts::AttributeHelpTexts(const Json::Value &pJson) noexcept(false)
{
    ...
    {
        _dirtyFlag[3]=true;
        if(!pJson["attribute_name"].isNull())
        {
...
bool AttributeHelpTexts::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("help_text"))
    {
        if(!validJsonOfField(1, "help_text", pJson["help_text"], err, true))
            return false;
    }
    else
    {
        err="The help_text column cannot be null";
        return false;
    }
    if(pJson.isMember("type"))
    {
    ...
    if(pJson.isMember("attribute_name"))
    {
        if(!validJsonOfField(3, "attribute_name", pJson["attribute_name"], err, true))
            return false;
    }
    else
    {
        err="The attribute_name column cannot be null";
        return false;
    }
    if(pJson.isMember("created_at"))
    {
...
bool AttributeHelpTexts::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool AttributeHelpTexts::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("help_text"))
    {
        if(!validJsonOfField(1, "help_text", pJson["help_text"], err, false))
            return false;
    }
    if(pJson.isMember("type"))
    {
    ...
    if(pJson.isMember("attribute_name"))
    {
        if(!validJsonOfField(3, "attribute_name", pJson["attribute_name"], err, false))
            return false;
    }
    if(pJson.isMember("created_at"))
    {
...
bool AttributeHelpTexts::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                          const std::vector<std::string> &pMasqueradingVector,
                                                          std::string &err)
{
    if(pMasqueradingVector.size() != 6)
...
bool AttributeHelpTexts::validJsonOfField(size_t index,
