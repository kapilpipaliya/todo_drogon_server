...
bool CostObjectJournals::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("fixed_date"))
    {
        if(!validJsonOfField(6, "fixed_date", pJson["fixed_date"], err, true))
            return false;
    }
    else
    {
        err="The fixed_date column cannot be null";
        return false;
    }
    if(pJson.isMember("created_on"))
    {
...
bool CostObjectJournals::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool CostObjectJournals::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("fixed_date"))
    {
        if(!validJsonOfField(6, "fixed_date", pJson["fixed_date"], err, false))
            return false;
    }
    if(pJson.isMember("created_on"))
    {
...
bool CostObjectJournals::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                          const std::vector<std::string> &pMasqueradingVector,
                                                          std::string &err)
{
    if(pMasqueradingVector.size() != 8)
...
bool CostObjectJournals::validJsonOfField(size_t index,
