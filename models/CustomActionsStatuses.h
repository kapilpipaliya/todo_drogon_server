...
class CustomActionsStatuses
{
  public:
     ...
     */
    explicit CustomActionsStatuses(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit CustomActionsStatuses(const Json::Value &pJson) noexcept(false);
     ...
     */
    CustomActionsStatuses(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    CustomActionsStatuses() = default;
    ...
    const int64_t &getValueOfStatusId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int64_t> &getStatusId() const noexcept;
    ///Set the value of the column status_id
    void setStatusId(const int64_t &pStatusId) noexcept;
  ...
  private:
    friend Mapper<CustomActionsStatuses>;
    ...
    std::shared_ptr<int64_t> _statusId;
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (status_id,custom_action_id) values ($1,$2) returning *";
        return sql;   
    }
};
} // namespace openproject6
