...
class WebhooksWebhooks
{
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (name,url,description,secret,enabled,all_projects,created_at,updated_at) values ($1,$2,$3,$4,$5,$6,$7,$8) returning *";
        return sql;   
    }
};
} // namespace openproject6
