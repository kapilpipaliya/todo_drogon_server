...
class LdapGroupsSynchronizedGroups
{
  public:
     ...
     */
    explicit LdapGroupsSynchronizedGroups(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit LdapGroupsSynchronizedGroups(const Json::Value &pJson) noexcept(false);
     ...
     */
    LdapGroupsSynchronizedGroups(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (entry,group_id,auth_source_id,created_at,updated_at) values ($1,$2,$3,$4,$5) returning *";
        return sql;   
    }
};
} // namespace openproject6
