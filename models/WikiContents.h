...
class WikiContents
{
  public:
     ...
     */
    explicit WikiContents(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit WikiContents(const Json::Value &pJson) noexcept(false);
     ...
     */
    WikiContents(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    WikiContents() = default;
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (page_id,author_id,text,updated_on,lock_version) values ($1,$2,$3,$4,$5) returning *";
        return sql;   
    }
};
} // namespace openproject6
