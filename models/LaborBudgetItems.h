...
class LaborBudgetItems
{
  public:
     ...
     */
    explicit LaborBudgetItems(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit LaborBudgetItems(const Json::Value &pJson) noexcept(false);
     ...
     */
    LaborBudgetItems(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (cost_object_id,hours,user_id,comments,budget) values ($1,$2,$3,$4,$5) returning *";
        return sql;   
    }
};
} // namespace openproject6
