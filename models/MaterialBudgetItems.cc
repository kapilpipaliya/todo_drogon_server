...
bool MaterialBudgetItems::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("units"))
    {
        if(!validJsonOfField(2, "units", pJson["units"], err, true))
            return false;
    }
    else
    {
    ...
    if(pJson.isMember("cost_type_id"))
    {
        if(!validJsonOfField(3, "cost_type_id", pJson["cost_type_id"], err, true))
            return false;
    }
    if(pJson.isMember("comments"))
    {
...
bool MaterialBudgetItems::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool MaterialBudgetItems::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("units"))
    {
        if(!validJsonOfField(2, "units", pJson["units"], err, false))
            return false;
    }
    if(pJson.isMember("cost_type_id"))
    {
        if(!validJsonOfField(3, "cost_type_id", pJson["cost_type_id"], err, false))
            return false;
    }
    if(pJson.isMember("comments"))
    {
...
bool MaterialBudgetItems::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                           const std::vector<std::string> &pMasqueradingVector,
                                                           std::string &err)
{
    if(pMasqueradingVector.size() != 6)
...
bool MaterialBudgetItems::validJsonOfField(size_t index,
