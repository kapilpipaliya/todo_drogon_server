...
class Settings
{
  public:
     ...
     */
    explicit Settings(const Row &r, const ssize_t indexOffset = 0) noexcept;
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (name,value,updated_on) values ($1,$2,$3) returning *";
        return sql;   
    }
};
} // namespace openproject6
