...
class DocumentJournals
{
  public:
     ...
     */
    explicit DocumentJournals(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit DocumentJournals(const Json::Value &pJson) noexcept(false);
     ...
     */
    DocumentJournals(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    DocumentJournals() = default;
  ...
  private:
    friend Mapper<DocumentJournals>;
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (journal_id,project_id,category_id,title,description,created_on) values ($1,$2,$3,$4,$5,$6) returning *";
        return sql;   
    }
};
} // namespace openproject6
