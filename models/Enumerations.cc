...
bool Enumerations::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("parent_id"))
    {
        if(!validJsonOfField(7, "parent_id", pJson["parent_id"], err, true))
            return false;
    }
    if(pJson.isMember("created_at"))
    {
    ...
    if(pJson.isMember("color_id"))
    {
        if(!validJsonOfField(10, "color_id", pJson["color_id"], err, true))
            return false;
    }
    return true;
}
bool Enumerations::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool Enumerations::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("parent_id"))
    {
        if(!validJsonOfField(7, "parent_id", pJson["parent_id"], err, false))
            return false;
    }
    if(pJson.isMember("created_at"))
    {
    ...
    if(pJson.isMember("color_id"))
    {
        if(!validJsonOfField(10, "color_id", pJson["color_id"], err, false))
            return false;
    }
    return true;
}
bool Enumerations::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                    const std::vector<std::string> &pMasqueradingVector,
                                                    std::string &err)
{
    if(pMasqueradingVector.size() != 11)
...
bool Enumerations::validJsonOfField(size_t index,
