...
class Grids
{
  public:
     ...
     */
    explicit Grids(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Grids(const Json::Value &pJson) noexcept(false);
     ...
     */
    Grids(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (row_count,column_count,type,user_id,created_at,updated_at,project_id,name,options) values ($1,$2,$3,$4,$5,$6,$7,$8,$9) returning *";
        return sql;   
    }
};
} // namespace openproject6
