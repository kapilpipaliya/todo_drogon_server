...
LaborBudgetItems::LaborBudgetItems(const Row &r, const ssize_t indexOffset) noexcept
{
    if(indexOffset < 0)
    {
        if(!r["id"].isNull())
...
LaborBudgetItems::LaborBudgetItems(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
...
LaborBudgetItems::LaborBudgetItems(const Json::Value &pJson) noexcept(false)
{
...
void LaborBudgetItems::updateByMasqueradedJson(const Json::Value &pJson,
...
void LaborBudgetItems::updateByJson(const Json::Value &pJson) noexcept(false)
{
    if(pJson.isMember("id"))
    {
        if(!pJson["id"].isNull())
...
Json::Value LaborBudgetItems::toMasqueradedJson(
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 6)
    {
        ...
        if(!pMasqueradingVector[2].empty())
        {
            if(getHours())
            {
                ret[pMasqueradingVector[2]]=getValueOfHours();
            }
            else
            {
...
bool LaborBudgetItems::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("cost_object_id"))
    {
        if(!validJsonOfField(1, "cost_object_id", pJson["cost_object_id"], err, true))
            return false;
    }
    else
    {
        err="The cost_object_id column cannot be null";
        return false;
    }
    if(pJson.isMember("hours"))
    {
        if(!validJsonOfField(2, "hours", pJson["hours"], err, true))
            return false;
    }
    else
    {
    ...
    if(pJson.isMember("budget"))
    {
        if(!validJsonOfField(5, "budget", pJson["budget"], err, true))
            return false;
    }
    return true;
}
bool LaborBudgetItems::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool LaborBudgetItems::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
    ...
    if(pJson.isMember("cost_object_id"))
    {
        if(!validJsonOfField(1, "cost_object_id", pJson["cost_object_id"], err, false))
            return false;
    }
    if(pJson.isMember("hours"))
    {
        if(!validJsonOfField(2, "hours", pJson["hours"], err, false))
            return false;
    }
    if(pJson.isMember("user_id"))
    {
    ...
    if(pJson.isMember("budget"))
    {
        if(!validJsonOfField(5, "budget", pJson["budget"], err, false))
            return false;
    }
    return true;
}
bool LaborBudgetItems::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                        const std::vector<std::string> &pMasqueradingVector,
                                                        std::string &err)
{
    if(pMasqueradingVector.size() != 6)
...
bool LaborBudgetItems::validJsonOfField(size_t index,
