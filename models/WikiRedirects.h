...
class WikiRedirects
{
  public:
     ...
     */
    explicit WikiRedirects(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit WikiRedirects(const Json::Value &pJson) noexcept(false);
     ...
     */
    WikiRedirects(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (wiki_id,title,redirects_to,created_on) values ($1,$2,$3,$4) returning *";
        return sql;   
    }
};
} // namespace openproject6
