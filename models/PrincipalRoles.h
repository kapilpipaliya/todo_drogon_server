...
class PrincipalRoles
{
  public:
    struct Cols
    {
        ...
        static const std::string _principal_id;
     ...
     */
    explicit PrincipalRoles(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit PrincipalRoles(const Json::Value &pJson) noexcept(false);
     ...
     */
    PrincipalRoles(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    PrincipalRoles() = default;
    ...
    /**  For column principal_id  */
    ///Get the value of the column principal_id, returns the default value if the column is null
    const int32_t &getValueOfPrincipalId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getPrincipalId() const noexcept;
    ///Set the value of the column principal_id
    void setPrincipalId(const int32_t &pPrincipalId) noexcept;
  ...
  private:
    ...
    std::shared_ptr<int32_t> _principalId;
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (role_id,principal_id,created_at,updated_at) values ($1,$2,$3,$4) returning *";
        return sql;   
    }
};
} // namespace openproject6
