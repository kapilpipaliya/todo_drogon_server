...
class CustomActionsTypes
{
  public:
     ...
     */
    explicit CustomActionsTypes(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit CustomActionsTypes(const Json::Value &pJson) noexcept(false);
     ...
     */
    CustomActionsTypes(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    CustomActionsTypes() = default;
  ...
  private:
    friend Mapper<CustomActionsTypes>;
    ...
    std::shared_ptr<int64_t> _typeId;
  ...
  public:
    ...
    {
        static const std::string sql="insert into " + tableName + " (type_id,custom_action_id) values ($1,$2) returning *";
        return sql;   
    }
};
} // namespace openproject6
