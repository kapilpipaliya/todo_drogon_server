/**
 *
 *  RestfulLaborBudgetItemsCtrlBase.cc
...
void RestfulLaborBudgetItemsCtrlBase::getOne(const HttpRequestPtr &req,
                                             ...
                                             LaborBudgetItems::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<LaborBudgetItems> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](LaborBudgetItems r) {
            if(_masquerading)
            {
...
void RestfulLaborBudgetItemsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback,
                                                LaborBudgetItems::PrimaryKeyType &&id)
{
...
void RestfulLaborBudgetItemsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback,
                                                LaborBudgetItems::PrimaryKeyType &&id)
{
...
void RestfulLaborBudgetItemsCtrlBase::get(const HttpRequestPtr &req,
                                          std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<LaborBudgetItems> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<LaborBudgetItems> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulLaborBudgetItemsCtrlBase::create(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        LaborBudgetItems object = 
            (_masquerading? 
             LaborBudgetItems(*jsonPtr, _masqueradingVector) : 
             LaborBudgetItems(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](LaborBudgetItems newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulLaborBudgetItemsCtrlBase::update(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback)
{
