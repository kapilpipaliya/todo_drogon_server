/**
 *
 *  RestfulRecaptchaEntriesCtrlBase.cc
...
void RestfulRecaptchaEntriesCtrlBase::getOne(const HttpRequestPtr &req,
                                             ...
                                             RecaptchaEntries::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<RecaptchaEntries> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](RecaptchaEntries r) {
            if(_masquerading)
            {
...
void RestfulRecaptchaEntriesCtrlBase::updateOne(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback,
                                                RecaptchaEntries::PrimaryKeyType &&id)
{
...
void RestfulRecaptchaEntriesCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback,
                                                RecaptchaEntries::PrimaryKeyType &&id)
{
...
void RestfulRecaptchaEntriesCtrlBase::get(const HttpRequestPtr &req,
                                          std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<RecaptchaEntries> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<RecaptchaEntries> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulRecaptchaEntriesCtrlBase::create(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        RecaptchaEntries object = 
            (_masquerading? 
             RecaptchaEntries(*jsonPtr, _masqueradingVector) : 
             RecaptchaEntries(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](RecaptchaEntries newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulRecaptchaEntriesCtrlBase::update(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback)
{
