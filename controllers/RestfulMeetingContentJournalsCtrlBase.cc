/**
 *
 *  RestfulMeetingContentJournalsCtrlBase.cc
...
void RestfulMeetingContentJournalsCtrlBase::getOne(const HttpRequestPtr &req,
                                                   ...
                                                   MeetingContentJournals::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<MeetingContentJournals> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](MeetingContentJournals r) {
            if(_masquerading)
            {
...
void RestfulMeetingContentJournalsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                      std::function<void(const HttpResponsePtr &)> &&callback,
                                                      MeetingContentJournals::PrimaryKeyType &&id)
{
...
void RestfulMeetingContentJournalsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                      std::function<void(const HttpResponsePtr &)> &&callback,
                                                      MeetingContentJournals::PrimaryKeyType &&id)
{
...
void RestfulMeetingContentJournalsCtrlBase::get(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<MeetingContentJournals> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<MeetingContentJournals> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulMeetingContentJournalsCtrlBase::create(const HttpRequestPtr &req,
                                                   std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        MeetingContentJournals object = 
            (_masquerading? 
             MeetingContentJournals(*jsonPtr, _masqueradingVector) : 
             MeetingContentJournals(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](MeetingContentJournals newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulMeetingContentJournalsCtrlBase::update(const HttpRequestPtr &req,
                                                   std::function<void(const HttpResponsePtr &)> &&callback)
{
