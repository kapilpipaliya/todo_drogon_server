/**
 *
 *  RestfulProjectAssociationsCtrlBase.h
...
class RestfulProjectAssociationsCtrlBase
{
  public:
...
//                std::function<void(const HttpResponsePtr &)> &&callback);
  ...
  protected:
    ...
    std::vector<std::string> _masqueradingVector={
          ...
          "project_a_id", // the alias for the project_a_id column.
          "project_b_id", // the alias for the project_b_id column.
