/**
 *
 *  RestfulCustomActionsStatusesCtrlBase.cc
...
void RestfulCustomActionsStatusesCtrlBase::getOne(const HttpRequestPtr &req,
                                                  ...
                                                  CustomActionsStatuses::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<CustomActionsStatuses> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](CustomActionsStatuses r) {
            if(_masquerading)
            {
...
void RestfulCustomActionsStatusesCtrlBase::updateOne(const HttpRequestPtr &req,
                                                     std::function<void(const HttpResponsePtr &)> &&callback,
                                                     CustomActionsStatuses::PrimaryKeyType &&id)
{
...
void RestfulCustomActionsStatusesCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                     std::function<void(const HttpResponsePtr &)> &&callback,
                                                     CustomActionsStatuses::PrimaryKeyType &&id)
{
...
void RestfulCustomActionsStatusesCtrlBase::get(const HttpRequestPtr &req,
                                               std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<CustomActionsStatuses> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<CustomActionsStatuses> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulCustomActionsStatusesCtrlBase::create(const HttpRequestPtr &req,
                                                  std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        CustomActionsStatuses object = 
            (_masquerading? 
             CustomActionsStatuses(*jsonPtr, _masqueradingVector) : 
             CustomActionsStatuses(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](CustomActionsStatuses newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulCustomActionsStatusesCtrlBase::update(const HttpRequestPtr &req,
                                                  std::function<void(const HttpResponsePtr &)> &&callback)
{
