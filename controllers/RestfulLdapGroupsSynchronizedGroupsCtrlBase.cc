/**
 *
 *  RestfulLdapGroupsSynchronizedGroupsCtrlBase.cc
...
void RestfulLdapGroupsSynchronizedGroupsCtrlBase::getOne(const HttpRequestPtr &req,
                                                         ...
                                                         LdapGroupsSynchronizedGroups::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<LdapGroupsSynchronizedGroups> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](LdapGroupsSynchronizedGroups r) {
            if(_masquerading)
            {
...
void RestfulLdapGroupsSynchronizedGroupsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                            std::function<void(const HttpResponsePtr &)> &&callback,
                                                            LdapGroupsSynchronizedGroups::PrimaryKeyType &&id)
{
    ...
    LdapGroupsSynchronizedGroups object;
    try
    {
        if(_masquerading)
        {
...
void RestfulLdapGroupsSynchronizedGroupsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                            std::function<void(const HttpResponsePtr &)> &&callback,
                                                            LdapGroupsSynchronizedGroups::PrimaryKeyType &&id)
{
...
void RestfulLdapGroupsSynchronizedGroupsCtrlBase::get(const HttpRequestPtr &req,
                                                      std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<LdapGroupsSynchronizedGroups> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<LdapGroupsSynchronizedGroups> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulLdapGroupsSynchronizedGroupsCtrlBase::create(const HttpRequestPtr &req,
                                                         std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        LdapGroupsSynchronizedGroups object = 
            (_masquerading? 
             LdapGroupsSynchronizedGroups(*jsonPtr, _masqueradingVector) : 
             LdapGroupsSynchronizedGroups(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](LdapGroupsSynchronizedGroups newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulLdapGroupsSynchronizedGroupsCtrlBase::update(const HttpRequestPtr &req,
                                                         std::function<void(const HttpResponsePtr &)> &&callback)
{
