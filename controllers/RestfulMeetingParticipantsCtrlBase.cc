/**
 *
 *  RestfulMeetingParticipantsCtrlBase.cc
...
void RestfulMeetingParticipantsCtrlBase::getOne(const HttpRequestPtr &req,
                                                ...
                                                MeetingParticipants::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<MeetingParticipants> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](MeetingParticipants r) {
            if(_masquerading)
            {
...
void RestfulMeetingParticipantsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                   std::function<void(const HttpResponsePtr &)> &&callback,
                                                   MeetingParticipants::PrimaryKeyType &&id)
{
...
void RestfulMeetingParticipantsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                   std::function<void(const HttpResponsePtr &)> &&callback,
                                                   MeetingParticipants::PrimaryKeyType &&id)
{
...
void RestfulMeetingParticipantsCtrlBase::get(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<MeetingParticipants> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<MeetingParticipants> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulMeetingParticipantsCtrlBase::create(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        MeetingParticipants object = 
            (_masquerading? 
             MeetingParticipants(*jsonPtr, _masqueradingVector) : 
             MeetingParticipants(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](MeetingParticipants newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulMeetingParticipantsCtrlBase::update(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback)
{
