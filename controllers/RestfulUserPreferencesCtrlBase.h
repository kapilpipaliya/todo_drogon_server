/**
 *
 *  RestfulUserPreferencesCtrlBase.h
...
class RestfulUserPreferencesCtrlBase
{
  public:
...
//                std::function<void(const HttpResponsePtr &)> &&callback);
  ...
  protected:
    ...
    std::vector<std::string> _masqueradingVector={
          ...
          "others", // the alias for the others column.
          "hide_mail", // the alias for the hide_mail column.
          "time_zone"  // the alias for the time_zone column.
    };
};
