/**
 *
 *  RestfulWikiContentJournalsCtrlBase.cc
                                                ...
                                                WikiContentJournals::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<WikiContentJournals> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](WikiContentJournals r) {
            if(_masquerading)
            {
...
void RestfulWikiContentJournalsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                   std::function<void(const HttpResponsePtr &)> &&callback,
                                                   WikiContentJournals::PrimaryKeyType &&id)
{
...
void RestfulWikiContentJournalsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                   std::function<void(const HttpResponsePtr &)> &&callback,
                                                   WikiContentJournals::PrimaryKeyType &&id)
{
...
void RestfulWikiContentJournalsCtrlBase::get(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<WikiContentJournals> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<WikiContentJournals> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulWikiContentJournalsCtrlBase::create(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        WikiContentJournals object = 
            (_masquerading? 
             WikiContentJournals(*jsonPtr, _masqueradingVector) : 
             WikiContentJournals(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](WikiContentJournals newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulWikiContentJournalsCtrlBase::update(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback)
{
