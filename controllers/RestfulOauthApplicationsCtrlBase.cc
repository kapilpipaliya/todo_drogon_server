/**
 *
 *  RestfulOauthApplicationsCtrlBase.cc
...
void RestfulOauthApplicationsCtrlBase::getOne(const HttpRequestPtr &req,
                                              ...
                                              OauthApplications::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<OauthApplications> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](OauthApplications r) {
            if(_masquerading)
            {
...
void RestfulOauthApplicationsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                 std::function<void(const HttpResponsePtr &)> &&callback,
                                                 OauthApplications::PrimaryKeyType &&id)
{
...
void RestfulOauthApplicationsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                 std::function<void(const HttpResponsePtr &)> &&callback,
                                                 OauthApplications::PrimaryKeyType &&id)
{
...
void RestfulOauthApplicationsCtrlBase::get(const HttpRequestPtr &req,
                                           std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<OauthApplications> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<OauthApplications> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulOauthApplicationsCtrlBase::create(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        OauthApplications object = 
            (_masquerading? 
             OauthApplications(*jsonPtr, _masqueradingVector) : 
             OauthApplications(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](OauthApplications newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulOauthApplicationsCtrlBase::update(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback)
{
