...
//                std::function<void(const HttpResponsePtr &)> &&callback);
  ...
  protected:
    ...
    std::vector<std::string> _masqueradingVector={
          ...
          "commented_type", // the alias for the commented_type column.
          "commented_id", // the alias for the commented_id column.
