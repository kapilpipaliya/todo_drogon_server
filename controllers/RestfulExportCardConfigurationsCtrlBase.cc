/**
 *
 *  RestfulExportCardConfigurationsCtrlBase.cc
                                                     ...
                                                     ExportCardConfigurations::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<ExportCardConfigurations> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](ExportCardConfigurations r) {
            if(_masquerading)
            {
...
void RestfulExportCardConfigurationsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                        std::function<void(const HttpResponsePtr &)> &&callback,
                                                        ExportCardConfigurations::PrimaryKeyType &&id)
{
    ...
    ExportCardConfigurations object;
    try
    {
        if(_masquerading)
        {
...
void RestfulExportCardConfigurationsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                        std::function<void(const HttpResponsePtr &)> &&callback,
                                                        ExportCardConfigurations::PrimaryKeyType &&id)
{
...
void RestfulExportCardConfigurationsCtrlBase::get(const HttpRequestPtr &req,
                                                  std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<ExportCardConfigurations> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<ExportCardConfigurations> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulExportCardConfigurationsCtrlBase::create(const HttpRequestPtr &req,
                                                     std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        ExportCardConfigurations object = 
            (_masquerading? 
             ExportCardConfigurations(*jsonPtr, _masqueradingVector) : 
             ExportCardConfigurations(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](ExportCardConfigurations newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulExportCardConfigurationsCtrlBase::update(const HttpRequestPtr &req,
                                                     std::function<void(const HttpResponsePtr &)> &&callback)
{
