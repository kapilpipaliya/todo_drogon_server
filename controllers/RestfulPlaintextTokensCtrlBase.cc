/**
 *
 *  RestfulPlaintextTokensCtrlBase.cc
...
void RestfulPlaintextTokensCtrlBase::getOne(const HttpRequestPtr &req,
                                            ...
                                            PlaintextTokens::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<PlaintextTokens> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](PlaintextTokens r) {
            if(_masquerading)
            {
...
void RestfulPlaintextTokensCtrlBase::updateOne(const HttpRequestPtr &req,
                                               std::function<void(const HttpResponsePtr &)> &&callback,
                                               PlaintextTokens::PrimaryKeyType &&id)
{
...
void RestfulPlaintextTokensCtrlBase::deleteOne(const HttpRequestPtr &req,
                                               std::function<void(const HttpResponsePtr &)> &&callback,
                                               PlaintextTokens::PrimaryKeyType &&id)
{
...
void RestfulPlaintextTokensCtrlBase::get(const HttpRequestPtr &req,
                                         std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<PlaintextTokens> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<PlaintextTokens> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulPlaintextTokensCtrlBase::create(const HttpRequestPtr &req,
                                            std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        PlaintextTokens object = 
            (_masquerading? 
             PlaintextTokens(*jsonPtr, _masqueradingVector) : 
             PlaintextTokens(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](PlaintextTokens newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulPlaintextTokensCtrlBase::update(const HttpRequestPtr &req,
                                            std::function<void(const HttpResponsePtr &)> &&callback)
{
