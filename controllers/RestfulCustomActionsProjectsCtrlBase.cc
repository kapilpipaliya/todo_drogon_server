/**
 *
 *  RestfulCustomActionsProjectsCtrlBase.cc
...
void RestfulCustomActionsProjectsCtrlBase::getOne(const HttpRequestPtr &req,
                                                  ...
                                                  CustomActionsProjects::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<CustomActionsProjects> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](CustomActionsProjects r) {
            if(_masquerading)
            {
...
void RestfulCustomActionsProjectsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                     std::function<void(const HttpResponsePtr &)> &&callback,
                                                     CustomActionsProjects::PrimaryKeyType &&id)
{
...
void RestfulCustomActionsProjectsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                     std::function<void(const HttpResponsePtr &)> &&callback,
                                                     CustomActionsProjects::PrimaryKeyType &&id)
{
...
void RestfulCustomActionsProjectsCtrlBase::get(const HttpRequestPtr &req,
                                               std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<CustomActionsProjects> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<CustomActionsProjects> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulCustomActionsProjectsCtrlBase::create(const HttpRequestPtr &req,
                                                  std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        CustomActionsProjects object = 
            (_masquerading? 
             CustomActionsProjects(*jsonPtr, _masqueradingVector) : 
             CustomActionsProjects(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](CustomActionsProjects newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulCustomActionsProjectsCtrlBase::update(const HttpRequestPtr &req,
                                                  std::function<void(const HttpResponsePtr &)> &&callback)
{
