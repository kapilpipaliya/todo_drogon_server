/**
 *
 *  RestfulLdapGroupsMembershipsCtrlBase.cc
...
void RestfulLdapGroupsMembershipsCtrlBase::getOne(const HttpRequestPtr &req,
                                                  ...
                                                  LdapGroupsMemberships::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<LdapGroupsMemberships> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](LdapGroupsMemberships r) {
            if(_masquerading)
            {
...
void RestfulLdapGroupsMembershipsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                     std::function<void(const HttpResponsePtr &)> &&callback,
                                                     LdapGroupsMemberships::PrimaryKeyType &&id)
{
...
void RestfulLdapGroupsMembershipsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                     std::function<void(const HttpResponsePtr &)> &&callback,
                                                     LdapGroupsMemberships::PrimaryKeyType &&id)
{
...
void RestfulLdapGroupsMembershipsCtrlBase::get(const HttpRequestPtr &req,
                                               std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<LdapGroupsMemberships> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<LdapGroupsMemberships> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulLdapGroupsMembershipsCtrlBase::create(const HttpRequestPtr &req,
                                                  std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        LdapGroupsMemberships object = 
            (_masquerading? 
             LdapGroupsMemberships(*jsonPtr, _masqueradingVector) : 
             LdapGroupsMemberships(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](LdapGroupsMemberships newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulLdapGroupsMembershipsCtrlBase::update(const HttpRequestPtr &req,
                                                  std::function<void(const HttpResponsePtr &)> &&callback)
{
