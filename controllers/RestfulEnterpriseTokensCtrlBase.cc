/**
 *
 *  RestfulEnterpriseTokensCtrlBase.cc
...
void RestfulEnterpriseTokensCtrlBase::getOne(const HttpRequestPtr &req,
                                             ...
                                             EnterpriseTokens::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<EnterpriseTokens> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](EnterpriseTokens r) {
            if(_masquerading)
            {
...
void RestfulEnterpriseTokensCtrlBase::updateOne(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback,
                                                EnterpriseTokens::PrimaryKeyType &&id)
{
...
void RestfulEnterpriseTokensCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback,
                                                EnterpriseTokens::PrimaryKeyType &&id)
{
...
void RestfulEnterpriseTokensCtrlBase::get(const HttpRequestPtr &req,
                                          std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<EnterpriseTokens> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<EnterpriseTokens> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulEnterpriseTokensCtrlBase::create(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        EnterpriseTokens object = 
            (_masquerading? 
             EnterpriseTokens(*jsonPtr, _masqueradingVector) : 
             EnterpriseTokens(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](EnterpriseTokens newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulEnterpriseTokensCtrlBase::update(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback)
{
