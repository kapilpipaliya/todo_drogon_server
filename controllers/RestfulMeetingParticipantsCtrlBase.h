/**
 *
 *  RestfulMeetingParticipantsCtrlBase.h
...
class RestfulMeetingParticipantsCtrlBase
{
  public:
...
//                std::function<void(const HttpResponsePtr &)> &&callback);
  ...
  protected:
    ...
    std::vector<std::string> _masqueradingVector={
          ...
          "invited", // the alias for the invited column.
          "attended", // the alias for the attended column.
