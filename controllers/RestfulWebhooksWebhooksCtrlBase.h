/**
 *
 *  RestfulWebhooksWebhooksCtrlBase.h
...
class RestfulWebhooksWebhooksCtrlBase
{
  public:
...
//                std::function<void(const HttpResponsePtr &)> &&callback);
  ...
  protected:
    ...
    std::vector<std::string> _masqueradingVector={
          ...
          "enabled", // the alias for the enabled column.
          "all_projects", // the alias for the all_projects column.
