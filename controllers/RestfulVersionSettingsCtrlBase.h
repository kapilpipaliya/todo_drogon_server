/**
 *
 *  RestfulVersionSettingsCtrlBase.h
...
class RestfulVersionSettingsCtrlBase
{
  public:
...
//                std::function<void(const HttpResponsePtr &)> &&callback);
  ...
  protected:
    ...
    std::vector<std::string> _masqueradingVector={
          ...
          "version_id", // the alias for the version_id column.
          "display", // the alias for the display column.
