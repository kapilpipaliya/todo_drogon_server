/**
 *
 *  RestfulOauthAccessGrantsCtrlBase.cc
...
void RestfulOauthAccessGrantsCtrlBase::getOne(const HttpRequestPtr &req,
                                              ...
                                              OauthAccessGrants::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<OauthAccessGrants> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](OauthAccessGrants r) {
            if(_masquerading)
            {
...
void RestfulOauthAccessGrantsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                 std::function<void(const HttpResponsePtr &)> &&callback,
                                                 OauthAccessGrants::PrimaryKeyType &&id)
{
...
void RestfulOauthAccessGrantsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                 std::function<void(const HttpResponsePtr &)> &&callback,
                                                 OauthAccessGrants::PrimaryKeyType &&id)
{
...
void RestfulOauthAccessGrantsCtrlBase::get(const HttpRequestPtr &req,
                                           std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<OauthAccessGrants> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<OauthAccessGrants> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulOauthAccessGrantsCtrlBase::create(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        OauthAccessGrants object = 
            (_masquerading? 
             OauthAccessGrants(*jsonPtr, _masqueradingVector) : 
             OauthAccessGrants(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](OauthAccessGrants newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulOauthAccessGrantsCtrlBase::update(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback)
{
