/**
 *
 *  RestfulOauthAccessTokensCtrlBase.cc
...
void RestfulOauthAccessTokensCtrlBase::getOne(const HttpRequestPtr &req,
                                              ...
                                              OauthAccessTokens::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<OauthAccessTokens> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](OauthAccessTokens r) {
            if(_masquerading)
            {
...
void RestfulOauthAccessTokensCtrlBase::updateOne(const HttpRequestPtr &req,
                                                 std::function<void(const HttpResponsePtr &)> &&callback,
                                                 OauthAccessTokens::PrimaryKeyType &&id)
{
...
void RestfulOauthAccessTokensCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                 std::function<void(const HttpResponsePtr &)> &&callback,
                                                 OauthAccessTokens::PrimaryKeyType &&id)
{
...
void RestfulOauthAccessTokensCtrlBase::get(const HttpRequestPtr &req,
                                           std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<OauthAccessTokens> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<OauthAccessTokens> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulOauthAccessTokensCtrlBase::create(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        OauthAccessTokens object = 
            (_masquerading? 
             OauthAccessTokens(*jsonPtr, _masqueradingVector) : 
             OauthAccessTokens(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](OauthAccessTokens newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulOauthAccessTokensCtrlBase::update(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback)
{
