...
class RestfulCustomValuesCtrlBase
{
  public:
...
//                std::function<void(const HttpResponsePtr &)> &&callback);
  ...
  protected:
    ...
    std::vector<std::string> _masqueradingVector={
          ...
          "customized_type", // the alias for the customized_type column.
          "customized_id", // the alias for the customized_id column.
