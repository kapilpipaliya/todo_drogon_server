...
void RestfulWatchersCtrlBase::getOne(const HttpRequestPtr &req,
                                     ...
                                     Watchers::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<Watchers> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](Watchers r) {
            if(_masquerading)
            {
...
void RestfulWatchersCtrlBase::updateOne(const HttpRequestPtr &req,
                                        std::function<void(const HttpResponsePtr &)> &&callback,
                                        Watchers::PrimaryKeyType &&id)
{
...
void RestfulWatchersCtrlBase::deleteOne(const HttpRequestPtr &req,
                                        std::function<void(const HttpResponsePtr &)> &&callback,
                                        Watchers::PrimaryKeyType &&id)
{
...
void RestfulWatchersCtrlBase::get(const HttpRequestPtr &req,
                                  std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<Watchers> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<Watchers> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulWatchersCtrlBase::create(const HttpRequestPtr &req,
                                     std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        Watchers object = 
            (_masquerading? 
             Watchers(*jsonPtr, _masqueradingVector) : 
             Watchers(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
        ...
        mapper.insert(
            object,
            [callbackPtr, this](Watchers newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulWatchersCtrlBase::update(const HttpRequestPtr &req,
                                     std::function<void(const HttpResponsePtr &)> &&callback)
{
