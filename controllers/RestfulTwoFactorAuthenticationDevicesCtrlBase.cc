/**
 *
 *  RestfulTwoFactorAuthenticationDevicesCtrlBase.cc
...
void RestfulTwoFactorAuthenticationDevicesCtrlBase::getOne(const HttpRequestPtr &req,
                                                           ...
                                                           TwoFactorAuthenticationDevices::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<TwoFactorAuthenticationDevices> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](TwoFactorAuthenticationDevices r) {
            if(_masquerading)
            {
...
void RestfulTwoFactorAuthenticationDevicesCtrlBase::updateOne(const HttpRequestPtr &req,
                                                              std::function<void(const HttpResponsePtr &)> &&callback,
                                                              TwoFactorAuthenticationDevices::PrimaryKeyType &&id)
{
    ...
    TwoFactorAuthenticationDevices object;
    try
    {
        if(_masquerading)
        {
...
void RestfulTwoFactorAuthenticationDevicesCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                              std::function<void(const HttpResponsePtr &)> &&callback,
                                                              TwoFactorAuthenticationDevices::PrimaryKeyType &&id)
{
...
void RestfulTwoFactorAuthenticationDevicesCtrlBase::get(const HttpRequestPtr &req,
                                                        std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<TwoFactorAuthenticationDevices> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<TwoFactorAuthenticationDevices> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulTwoFactorAuthenticationDevicesCtrlBase::create(const HttpRequestPtr &req,
                                                           std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        TwoFactorAuthenticationDevices object = 
            (_masquerading? 
             TwoFactorAuthenticationDevices(*jsonPtr, _masqueradingVector) : 
             TwoFactorAuthenticationDevices(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](TwoFactorAuthenticationDevices newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulTwoFactorAuthenticationDevicesCtrlBase::update(const HttpRequestPtr &req,
                                                           std::function<void(const HttpResponsePtr &)> &&callback)
{
