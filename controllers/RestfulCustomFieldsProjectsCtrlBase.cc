/**
 *
 *  RestfulCustomFieldsProjectsCtrlBase.cc
...
void RestfulCustomFieldsProjectsCtrlBase::get(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<CustomFieldsProjects> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<CustomFieldsProjects> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulCustomFieldsProjectsCtrlBase::create(const HttpRequestPtr &req,
                                                 std::function<void(const HttpResponsePtr &)> &&callback)
{
    ...
    try 
    {
        CustomFieldsProjects object = 
            (_masquerading? 
             CustomFieldsProjects(*jsonPtr, _masqueradingVector) : 
             CustomFieldsProjects(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](CustomFieldsProjects newObject){
                if(_masquerading)
                {
...
/*
void RestfulCustomFieldsProjectsCtrlBase::update(const HttpRequestPtr &req,
                                                 std::function<void(const HttpResponsePtr &)> &&callback)
{
