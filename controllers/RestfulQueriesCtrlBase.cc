...
void RestfulQueriesCtrlBase::getOne(const HttpRequestPtr &req,
                                    ...
                                    Queries::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<Queries> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](Queries r) {
            if(_masquerading)
            {
...
void RestfulQueriesCtrlBase::updateOne(const HttpRequestPtr &req,
                                       std::function<void(const HttpResponsePtr &)> &&callback,
                                       Queries::PrimaryKeyType &&id)
{
...
void RestfulQueriesCtrlBase::deleteOne(const HttpRequestPtr &req,
                                       std::function<void(const HttpResponsePtr &)> &&callback,
                                       Queries::PrimaryKeyType &&id)
{
...
void RestfulQueriesCtrlBase::get(const HttpRequestPtr &req,
                                 std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<Queries> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<Queries> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulQueriesCtrlBase::create(const HttpRequestPtr &req,
                                    std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        Queries object = 
            (_masquerading? 
             Queries(*jsonPtr, _masqueradingVector) : 
             Queries(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
        ...
        mapper.insert(
            object,
            [callbackPtr, this](Queries newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulQueriesCtrlBase::update(const HttpRequestPtr &req,
                                    std::function<void(const HttpResponsePtr &)> &&callback)
{
