/**
 *
 *  RestfulWebhooksEventsCtrlBase.cc
...
void RestfulWebhooksEventsCtrlBase::getOne(const HttpRequestPtr &req,
                                           ...
                                           WebhooksEvents::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<WebhooksEvents> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](WebhooksEvents r) {
            if(_masquerading)
            {
...
void RestfulWebhooksEventsCtrlBase::updateOne(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback,
                                              WebhooksEvents::PrimaryKeyType &&id)
{
...
void RestfulWebhooksEventsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback,
                                              WebhooksEvents::PrimaryKeyType &&id)
{
...
void RestfulWebhooksEventsCtrlBase::get(const HttpRequestPtr &req,
                                        std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<WebhooksEvents> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<WebhooksEvents> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulWebhooksEventsCtrlBase::create(const HttpRequestPtr &req,
                                           std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        WebhooksEvents object = 
            (_masquerading? 
             WebhooksEvents(*jsonPtr, _masqueradingVector) : 
             WebhooksEvents(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](WebhooksEvents newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulWebhooksEventsCtrlBase::update(const HttpRequestPtr &req,
                                           std::function<void(const HttpResponsePtr &)> &&callback)
{
