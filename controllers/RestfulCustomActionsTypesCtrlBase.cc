/**
 *
 *  RestfulCustomActionsTypesCtrlBase.cc
...
void RestfulCustomActionsTypesCtrlBase::getOne(const HttpRequestPtr &req,
                                               ...
                                               CustomActionsTypes::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<CustomActionsTypes> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](CustomActionsTypes r) {
            if(_masquerading)
            {
...
void RestfulCustomActionsTypesCtrlBase::updateOne(const HttpRequestPtr &req,
                                                  std::function<void(const HttpResponsePtr &)> &&callback,
                                                  CustomActionsTypes::PrimaryKeyType &&id)
{
...
void RestfulCustomActionsTypesCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                  std::function<void(const HttpResponsePtr &)> &&callback,
                                                  CustomActionsTypes::PrimaryKeyType &&id)
{
...
void RestfulCustomActionsTypesCtrlBase::get(const HttpRequestPtr &req,
                                            std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<CustomActionsTypes> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<CustomActionsTypes> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulCustomActionsTypesCtrlBase::create(const HttpRequestPtr &req,
                                               std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        CustomActionsTypes object = 
            (_masquerading? 
             CustomActionsTypes(*jsonPtr, _masqueradingVector) : 
             CustomActionsTypes(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](CustomActionsTypes newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulCustomActionsTypesCtrlBase::update(const HttpRequestPtr &req,
                                               std::function<void(const HttpResponsePtr &)> &&callback)
{
