/**
 *
 *  RestfulCustomizableJournalsCtrlBase.cc
...
void RestfulCustomizableJournalsCtrlBase::getOne(const HttpRequestPtr &req,
                                                 ...
                                                 CustomizableJournals::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<CustomizableJournals> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](CustomizableJournals r) {
            if(_masquerading)
            {
...
void RestfulCustomizableJournalsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                    std::function<void(const HttpResponsePtr &)> &&callback,
                                                    CustomizableJournals::PrimaryKeyType &&id)
{
...
void RestfulCustomizableJournalsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                    std::function<void(const HttpResponsePtr &)> &&callback,
                                                    CustomizableJournals::PrimaryKeyType &&id)
{
...
void RestfulCustomizableJournalsCtrlBase::get(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<CustomizableJournals> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<CustomizableJournals> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulCustomizableJournalsCtrlBase::create(const HttpRequestPtr &req,
                                                 std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        CustomizableJournals object = 
            (_masquerading? 
             CustomizableJournals(*jsonPtr, _masqueradingVector) : 
             CustomizableJournals(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](CustomizableJournals newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulCustomizableJournalsCtrlBase::update(const HttpRequestPtr &req,
                                                 std::function<void(const HttpResponsePtr &)> &&callback)
{
