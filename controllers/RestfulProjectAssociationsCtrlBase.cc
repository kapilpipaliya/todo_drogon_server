/**
 *
 *  RestfulProjectAssociationsCtrlBase.cc
                                                ...
                                                ProjectAssociations::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<ProjectAssociations> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](ProjectAssociations r) {
            if(_masquerading)
            {
...
void RestfulProjectAssociationsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                   std::function<void(const HttpResponsePtr &)> &&callback,
                                                   ProjectAssociations::PrimaryKeyType &&id)
{
...
void RestfulProjectAssociationsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                   std::function<void(const HttpResponsePtr &)> &&callback,
                                                   ProjectAssociations::PrimaryKeyType &&id)
{
...
void RestfulProjectAssociationsCtrlBase::get(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<ProjectAssociations> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<ProjectAssociations> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulProjectAssociationsCtrlBase::create(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        ProjectAssociations object = 
            (_masquerading? 
             ProjectAssociations(*jsonPtr, _masqueradingVector) : 
             ProjectAssociations(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](ProjectAssociations newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulProjectAssociationsCtrlBase::update(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback)
{
