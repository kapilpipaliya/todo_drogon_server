/**
 *
 *  RestfulCustomFieldsTypesCtrlBase.cc
                                           ...
                                           std::function<void(const HttpResponsePtr &)> &&callback)
{
    ...
    drogon::orm::Mapper<CustomFieldsTypes> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<CustomFieldsTypes> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulCustomFieldsTypesCtrlBase::create(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback)
{
    ...
    try 
    {
        CustomFieldsTypes object = 
            (_masquerading? 
             CustomFieldsTypes(*jsonPtr, _masqueradingVector) : 
             CustomFieldsTypes(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](CustomFieldsTypes newObject){
                if(_masquerading)
                {
...
/*
void RestfulCustomFieldsTypesCtrlBase::update(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback)
{
