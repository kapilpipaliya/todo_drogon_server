/**
 *
 *  RestfulWikiRedirectsCtrlBase.cc
...
void RestfulWikiRedirectsCtrlBase::getOne(const HttpRequestPtr &req,
                                          ...
                                          WikiRedirects::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<WikiRedirects> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](WikiRedirects r) {
            if(_masquerading)
            {
...
void RestfulWikiRedirectsCtrlBase::updateOne(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback,
                                             WikiRedirects::PrimaryKeyType &&id)
{
...
void RestfulWikiRedirectsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback,
                                             WikiRedirects::PrimaryKeyType &&id)
{
...
void RestfulWikiRedirectsCtrlBase::get(const HttpRequestPtr &req,
                                       std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<WikiRedirects> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<WikiRedirects> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulWikiRedirectsCtrlBase::create(const HttpRequestPtr &req,
                                          std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        WikiRedirects object = 
            (_masquerading? 
             WikiRedirects(*jsonPtr, _masqueradingVector) : 
             WikiRedirects(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](WikiRedirects newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulWikiRedirectsCtrlBase::update(const HttpRequestPtr &req,
                                          std::function<void(const HttpResponsePtr &)> &&callback)
{
