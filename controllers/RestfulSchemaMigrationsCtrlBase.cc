/**
 *
 *  RestfulSchemaMigrationsCtrlBase.cc
...
void RestfulSchemaMigrationsCtrlBase::getOne(const HttpRequestPtr &req,
                                             ...
                                             SchemaMigrations::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<SchemaMigrations> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](SchemaMigrations r) {
            if(_masquerading)
            {
...
void RestfulSchemaMigrationsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback,
                                                SchemaMigrations::PrimaryKeyType &&id)
{
...
void RestfulSchemaMigrationsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback,
                                                SchemaMigrations::PrimaryKeyType &&id)
{
...
void RestfulSchemaMigrationsCtrlBase::get(const HttpRequestPtr &req,
                                          std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<SchemaMigrations> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<SchemaMigrations> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulSchemaMigrationsCtrlBase::create(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        SchemaMigrations object = 
            (_masquerading? 
             SchemaMigrations(*jsonPtr, _masqueradingVector) : 
             SchemaMigrations(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](SchemaMigrations newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulSchemaMigrationsCtrlBase::update(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback)
{
