/**
 *
 *  RestfulUserPasswordsCtrlBase.h
...
class RestfulUserPasswordsCtrlBase
{
  public:
...
//                std::function<void(const HttpResponsePtr &)> &&callback);
  ...
  protected:
    ...
    std::vector<std::string> _masqueradingVector={
          ...
          "hashed_password", // the alias for the hashed_password column.
          "salt", // the alias for the salt column.
