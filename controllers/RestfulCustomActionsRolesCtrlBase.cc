/**
 *
 *  RestfulCustomActionsRolesCtrlBase.cc
...
void RestfulCustomActionsRolesCtrlBase::getOne(const HttpRequestPtr &req,
                                               ...
                                               CustomActionsRoles::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<CustomActionsRoles> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](CustomActionsRoles r) {
            if(_masquerading)
            {
...
void RestfulCustomActionsRolesCtrlBase::updateOne(const HttpRequestPtr &req,
                                                  std::function<void(const HttpResponsePtr &)> &&callback,
                                                  CustomActionsRoles::PrimaryKeyType &&id)
{
...
void RestfulCustomActionsRolesCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                  std::function<void(const HttpResponsePtr &)> &&callback,
                                                  CustomActionsRoles::PrimaryKeyType &&id)
{
...
void RestfulCustomActionsRolesCtrlBase::get(const HttpRequestPtr &req,
                                            std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<CustomActionsRoles> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<CustomActionsRoles> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulCustomActionsRolesCtrlBase::create(const HttpRequestPtr &req,
                                               std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        CustomActionsRoles object = 
            (_masquerading? 
             CustomActionsRoles(*jsonPtr, _masqueradingVector) : 
             CustomActionsRoles(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](CustomActionsRoles newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulCustomActionsRolesCtrlBase::update(const HttpRequestPtr &req,
                                               std::function<void(const HttpResponsePtr &)> &&callback)
{
