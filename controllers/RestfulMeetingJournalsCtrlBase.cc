/**
 *
 *  RestfulMeetingJournalsCtrlBase.cc
...
void RestfulMeetingJournalsCtrlBase::getOne(const HttpRequestPtr &req,
                                            ...
                                            MeetingJournals::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<MeetingJournals> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](MeetingJournals r) {
            if(_masquerading)
            {
...
void RestfulMeetingJournalsCtrlBase::updateOne(const HttpRequestPtr &req,
                                               std::function<void(const HttpResponsePtr &)> &&callback,
                                               MeetingJournals::PrimaryKeyType &&id)
{
...
void RestfulMeetingJournalsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                               std::function<void(const HttpResponsePtr &)> &&callback,
                                               MeetingJournals::PrimaryKeyType &&id)
{
...
void RestfulMeetingJournalsCtrlBase::get(const HttpRequestPtr &req,
                                         std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<MeetingJournals> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<MeetingJournals> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulMeetingJournalsCtrlBase::create(const HttpRequestPtr &req,
                                            std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        MeetingJournals object = 
            (_masquerading? 
             MeetingJournals(*jsonPtr, _masqueradingVector) : 
             MeetingJournals(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](MeetingJournals newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulMeetingJournalsCtrlBase::update(const HttpRequestPtr &req,
                                            std::function<void(const HttpResponsePtr &)> &&callback)
{
