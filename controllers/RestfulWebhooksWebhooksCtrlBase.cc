/**
 *
 *  RestfulWebhooksWebhooksCtrlBase.cc
...
void RestfulWebhooksWebhooksCtrlBase::getOne(const HttpRequestPtr &req,
                                             ...
                                             WebhooksWebhooks::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<WebhooksWebhooks> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](WebhooksWebhooks r) {
            if(_masquerading)
            {
...
void RestfulWebhooksWebhooksCtrlBase::updateOne(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback,
                                                WebhooksWebhooks::PrimaryKeyType &&id)
{
...
void RestfulWebhooksWebhooksCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback,
                                                WebhooksWebhooks::PrimaryKeyType &&id)
{
...
void RestfulWebhooksWebhooksCtrlBase::get(const HttpRequestPtr &req,
                                          std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<WebhooksWebhooks> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<WebhooksWebhooks> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulWebhooksWebhooksCtrlBase::create(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        WebhooksWebhooks object = 
            (_masquerading? 
             WebhooksWebhooks(*jsonPtr, _masqueradingVector) : 
             WebhooksWebhooks(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](WebhooksWebhooks newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulWebhooksWebhooksCtrlBase::update(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback)
{
