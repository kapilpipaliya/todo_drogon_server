/**
 *
 *  RestfulCostObjectJournalsCtrlBase.cc
...
void RestfulCostObjectJournalsCtrlBase::getOne(const HttpRequestPtr &req,
                                               ...
                                               CostObjectJournals::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<CostObjectJournals> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](CostObjectJournals r) {
            if(_masquerading)
            {
...
void RestfulCostObjectJournalsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                  std::function<void(const HttpResponsePtr &)> &&callback,
                                                  CostObjectJournals::PrimaryKeyType &&id)
{
...
void RestfulCostObjectJournalsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                  std::function<void(const HttpResponsePtr &)> &&callback,
                                                  CostObjectJournals::PrimaryKeyType &&id)
{
...
void RestfulCostObjectJournalsCtrlBase::get(const HttpRequestPtr &req,
                                            std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<CostObjectJournals> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<CostObjectJournals> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulCostObjectJournalsCtrlBase::create(const HttpRequestPtr &req,
                                               std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        CostObjectJournals object = 
            (_masquerading? 
             CostObjectJournals(*jsonPtr, _masqueradingVector) : 
             CostObjectJournals(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](CostObjectJournals newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulCostObjectJournalsCtrlBase::update(const HttpRequestPtr &req,
                                               std::function<void(const HttpResponsePtr &)> &&callback)
{
