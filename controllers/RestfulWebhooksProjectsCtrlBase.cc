/**
 *
 *  RestfulWebhooksProjectsCtrlBase.cc
...
void RestfulWebhooksProjectsCtrlBase::getOne(const HttpRequestPtr &req,
                                             ...
                                             WebhooksProjects::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<WebhooksProjects> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](WebhooksProjects r) {
            if(_masquerading)
            {
...
void RestfulWebhooksProjectsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback,
                                                WebhooksProjects::PrimaryKeyType &&id)
{
...
void RestfulWebhooksProjectsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback,
                                                WebhooksProjects::PrimaryKeyType &&id)
{
...
void RestfulWebhooksProjectsCtrlBase::get(const HttpRequestPtr &req,
                                          std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<WebhooksProjects> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<WebhooksProjects> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulWebhooksProjectsCtrlBase::create(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        WebhooksProjects object = 
            (_masquerading? 
             WebhooksProjects(*jsonPtr, _masqueradingVector) : 
             WebhooksProjects(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](WebhooksProjects newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulWebhooksProjectsCtrlBase::update(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback)
{
