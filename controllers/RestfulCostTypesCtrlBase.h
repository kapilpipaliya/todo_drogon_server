...
class RestfulCostTypesCtrlBase
{
  public:
...
//                std::function<void(const HttpResponsePtr &)> &&callback);
  ...
  protected:
    ...
    std::vector<std::string> _masqueradingVector={
          ...
          "unit_plural", // the alias for the unit_plural column.
          "default", // the alias for the default column.
          "deleted_at"  // the alias for the deleted_at column.
    };
};
