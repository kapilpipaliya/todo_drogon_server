/**
 *
 *  RestfulPrincipalRolesCtrlBase.cc
...
void RestfulPrincipalRolesCtrlBase::getOne(const HttpRequestPtr &req,
                                           ...
                                           PrincipalRoles::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<PrincipalRoles> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](PrincipalRoles r) {
            if(_masquerading)
            {
...
void RestfulPrincipalRolesCtrlBase::updateOne(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback,
                                              PrincipalRoles::PrimaryKeyType &&id)
{
...
void RestfulPrincipalRolesCtrlBase::deleteOne(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback,
                                              PrincipalRoles::PrimaryKeyType &&id)
{
...
void RestfulPrincipalRolesCtrlBase::get(const HttpRequestPtr &req,
                                        std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<PrincipalRoles> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<PrincipalRoles> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulPrincipalRolesCtrlBase::create(const HttpRequestPtr &req,
                                           std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        PrincipalRoles object = 
            (_masquerading? 
             PrincipalRoles(*jsonPtr, _masqueradingVector) : 
             PrincipalRoles(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](PrincipalRoles newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulPrincipalRolesCtrlBase::update(const HttpRequestPtr &req,
                                           std::function<void(const HttpResponsePtr &)> &&callback)
{
