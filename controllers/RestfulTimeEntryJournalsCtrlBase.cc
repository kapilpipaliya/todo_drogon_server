/**
 *
 *  RestfulTimeEntryJournalsCtrlBase.cc
...
void RestfulTimeEntryJournalsCtrlBase::getOne(const HttpRequestPtr &req,
                                              ...
                                              TimeEntryJournals::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<TimeEntryJournals> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](TimeEntryJournals r) {
            if(_masquerading)
            {
...
void RestfulTimeEntryJournalsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                 std::function<void(const HttpResponsePtr &)> &&callback,
                                                 TimeEntryJournals::PrimaryKeyType &&id)
{
...
void RestfulTimeEntryJournalsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                 std::function<void(const HttpResponsePtr &)> &&callback,
                                                 TimeEntryJournals::PrimaryKeyType &&id)
{
...
void RestfulTimeEntryJournalsCtrlBase::get(const HttpRequestPtr &req,
                                           std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<TimeEntryJournals> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<TimeEntryJournals> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulTimeEntryJournalsCtrlBase::create(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        TimeEntryJournals object = 
            (_masquerading? 
             TimeEntryJournals(*jsonPtr, _masqueradingVector) : 
             TimeEntryJournals(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](TimeEntryJournals newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulTimeEntryJournalsCtrlBase::update(const HttpRequestPtr &req,
                                              std::function<void(const HttpResponsePtr &)> &&callback)
{
