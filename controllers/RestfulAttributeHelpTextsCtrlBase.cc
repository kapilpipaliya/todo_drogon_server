/**
 *
 *  RestfulAttributeHelpTextsCtrlBase.cc
...
void RestfulAttributeHelpTextsCtrlBase::getOne(const HttpRequestPtr &req,
                                               ...
                                               AttributeHelpTexts::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<AttributeHelpTexts> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](AttributeHelpTexts r) {
            if(_masquerading)
            {
...
void RestfulAttributeHelpTextsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                  std::function<void(const HttpResponsePtr &)> &&callback,
                                                  AttributeHelpTexts::PrimaryKeyType &&id)
{
...
void RestfulAttributeHelpTextsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                  std::function<void(const HttpResponsePtr &)> &&callback,
                                                  AttributeHelpTexts::PrimaryKeyType &&id)
{
...
void RestfulAttributeHelpTextsCtrlBase::get(const HttpRequestPtr &req,
                                            std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<AttributeHelpTexts> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<AttributeHelpTexts> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulAttributeHelpTextsCtrlBase::create(const HttpRequestPtr &req,
                                               std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        AttributeHelpTexts object = 
            (_masquerading? 
             AttributeHelpTexts(*jsonPtr, _masqueradingVector) : 
             AttributeHelpTexts(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](AttributeHelpTexts newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulAttributeHelpTextsCtrlBase::update(const HttpRequestPtr &req,
                                               std::function<void(const HttpResponsePtr &)> &&callback)
{
