...
//                std::function<void(const HttpResponsePtr &)> &&callback);
  ...
  protected:
    ...
    std::vector<std::string> _masqueradingVector={
          ...
          "watchable_type", // the alias for the watchable_type column.
          "watchable_id", // the alias for the watchable_id column.
