/**
 *
 *  RestfulWorkPackageJournalsCtrlBase.cc
...
void RestfulWorkPackageJournalsCtrlBase::getOne(const HttpRequestPtr &req,
                                                ...
                                                WorkPackageJournals::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<WorkPackageJournals> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](WorkPackageJournals r) {
            if(_masquerading)
            {
...
void RestfulWorkPackageJournalsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                   std::function<void(const HttpResponsePtr &)> &&callback,
                                                   WorkPackageJournals::PrimaryKeyType &&id)
{
...
void RestfulWorkPackageJournalsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                   std::function<void(const HttpResponsePtr &)> &&callback,
                                                   WorkPackageJournals::PrimaryKeyType &&id)
{
...
void RestfulWorkPackageJournalsCtrlBase::get(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<WorkPackageJournals> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<WorkPackageJournals> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulWorkPackageJournalsCtrlBase::create(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        WorkPackageJournals object = 
            (_masquerading? 
             WorkPackageJournals(*jsonPtr, _masqueradingVector) : 
             WorkPackageJournals(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](WorkPackageJournals newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulWorkPackageJournalsCtrlBase::update(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback)
{
