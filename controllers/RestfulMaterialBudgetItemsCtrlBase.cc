/**
 *
 *  RestfulMaterialBudgetItemsCtrlBase.cc
...
void RestfulMaterialBudgetItemsCtrlBase::getOne(const HttpRequestPtr &req,
                                                ...
                                                MaterialBudgetItems::PrimaryKeyType &&id)
{
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    drogon::orm::Mapper<MaterialBudgetItems> mapper(dbClientPtr);
    mapper.findByPrimaryKey(
        id,
        [callbackPtr, this](MaterialBudgetItems r) {
            if(_masquerading)
            {
...
void RestfulMaterialBudgetItemsCtrlBase::updateOne(const HttpRequestPtr &req,
                                                   std::function<void(const HttpResponsePtr &)> &&callback,
                                                   MaterialBudgetItems::PrimaryKeyType &&id)
{
...
void RestfulMaterialBudgetItemsCtrlBase::deleteOne(const HttpRequestPtr &req,
                                                   std::function<void(const HttpResponsePtr &)> &&callback,
                                                   MaterialBudgetItems::PrimaryKeyType &&id)
{
...
void RestfulMaterialBudgetItemsCtrlBase::get(const HttpRequestPtr &req,
                                             std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<MaterialBudgetItems> mapper(dbClientPtr);
    ...
    auto callbackPtr =
        std::make_shared<std::function<void(const HttpResponsePtr &)>>(
            std::move(callback));
    mapper.findAll([callbackPtr, this](const std::vector<MaterialBudgetItems> &v) {
            Json::Value ret;
            ret.resize(0);
            for (auto &obj : v)
            {
...
void RestfulMaterialBudgetItemsCtrlBase::create(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        MaterialBudgetItems object = 
            (_masquerading? 
             MaterialBudgetItems(*jsonPtr, _masqueradingVector) : 
             MaterialBudgetItems(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
                std::move(callback));
        ...
        mapper.insert(
            object,
            [callbackPtr, this](MaterialBudgetItems newObject){
                if(_masquerading)
                {
                    (*callbackPtr)(HttpResponse::newHttpJsonResponse(
...
/*
void RestfulMaterialBudgetItemsCtrlBase::update(const HttpRequestPtr &req,
                                                std::function<void(const HttpResponsePtr &)> &&callback)
{
